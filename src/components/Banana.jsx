  ...
  return (
    <group {...props} dispose={null} ref={group}>
      <group name="origin" position={[0.023, 0.008, 0.017]}>
        <mesh name="pasted__pCube11_group_1" geometry={nodes.pasted__pCube11_group_1.geometry} material={materials.blinn10SG} />
        <mesh name="pasted__pCube11_group_1_1" geometry={nodes.pasted__pCube11_group_1_1.geometry} material={materials.blinn2SG} />
      </group>
      <group name="pasted__pCube11_group_cell" position={[-0.432, 2.664, 1.218]}>
      ...
      <group name="pasted__pCube11_group_cell001" position={[-0.329, -2.439, -0.076]}>
      ...
      <group name="pasted__pCube11_group_cell002" position={[0.017, 3.559, 1.284]}>
      ...
      <group name="pasted__pCube11_group_cell004" position={[0.698, -1.093, -0.067]}>
      ...
      <group name="pasted__pCube11_group_cell007" position={[-0.333, -3.587, 0.377]}>
      ...
      <group name="pasted__pCube11_group_cell009" position={[-0.257, 2.161, -0.17]}>
        <mesh name="pasted__pCube11_group_cell004_1" geometry={nodes.pasted__pCube11_group_cell004_1.geometry} material={materials.blinn10SG} />
        <mesh name="pasted__pCube11_group_cell004_2" geometry={nodes.pasted__pCube11_group_cell004_2.geometry} material={materials.blinn2SG} />
      </group>
      <group name="pasted__pCube11_group_cell010" position={[-0.166, -3.909, 1.292]}>
      ...
      <group name="pasted__pCube11_group_cell012" position={[-0.473, 2.77, 0.47]}>
        <mesh name="pasted__pCube11_group_cell006" geometry={nodes.pasted__pCube11_group_cell006.geometry} material={materials.blinn10SG} />
        <mesh name="pasted__pCube11_group_cell006_1" geometry={nodes.pasted__pCube11_group_cell006_1.geometry} material={materials.blinn2SG} />
      </group>
      <group name="pasted__pCube11_group_cell013" position={[-0.584, -3.482, 0.172]}>
      ...
      <group name="pasted__pCube11_group_cell014" position={[-0.004, 4.296, 2.33]}>
      ...
      <group name="pasted__pCube11_group_cell015" position={[0.281, -3.462, 0.976]}>
      ...
      <group name="pasted__pCube11_group_cell016" position={[0.483, -3.628, 0.684]}>
      ...
      <group name="pasted__pCube11_group_cell017" position={[0.142, 1.093, 0.336]}>
      ...
      <group name="pasted__pCube11_group_cell018" position={[-0.007, 2.873, 0.843]}>
      ...
      <group name="pasted__pCube11_group_cell019" position={[-0.379, -3.224, 0.776]}>
      ...
      <group name="pasted__pCube11_group_cell020" position={[-0.237, 1.896, 0.724]}>
      ...
      <group name="pasted__pCube11_group_cell022" position={[-0.113, -0.682, -0.968]}>
      ...
      <group name="pasted__pCube11_group_cell023" position={[-0.056, -3.86, 0.895]}>
      ...
      <group name="pasted__pCube11_group_cell025" position={[-0.364, 3.56, 0.716]}>
      ...
      <group name="pasted__pCube11_group_cell026" position={[-0.285, -3.261, 1.208]}>
      ...
      <group name="pasted__pCube11_group_cell027" position={[0.597, -3.135, 0.064]}>
      ...
      <group name="pasted__pCube11_group_cell028" position={[0.086, -3.956, 1.302]}>
      ...
      <group name="pasted__pCube11_group_cell029" position={[0.375, -2.111, 0.025]}>
        <mesh name="pasted__pCube11_group_cell021" geometry={nodes.pasted__pCube11_group_cell021.geometry} material={materials.blinn10SG} />
        <mesh name="pasted__pCube11_group_cell021_1" geometry={nodes.pasted__pCube11_group_cell021_1.geometry} material={materials.blinn2SG} />
      </group>
      <group name="pasted__pCube11_group_cell031" position={[0.594, 1.909, -0.004]}>
      ...
      <group name="pasted__pCube11_group_cell032" position={[-0.019, 3.918, 1.898]}>
      ...
      <group name="pasted__pCube11_group_cell033" position={[0.074, 0.162, -0.637]}>
        <mesh name="pasted__pCube11_group_cell024" geometry={nodes.pasted__pCube11_group_cell024.geometry} material={materials.blinn10SG} />
        <mesh name="pasted__pCube11_group_cell024_1" geometry={nodes.pasted__pCube11_group_cell024_1.geometry} material={materials.blinn2SG} />
      </group>
      <group name="pasted__pCube11_group_cell034" position={[-0.209, 3.882, 1.411]}>
      ...
      <group name="pasted__pCube11_group_cell035" position={[0.126, -3.383, 0.317]}>
      ...
      <group name="pasted__pCube11_group_cell037" position={[-0.099, -0.634, 0.11]}>
      ...
      <group name="pasted__pCube11_group_cell038" position={[0.887, -2.53, -0.708]}>
        <mesh name="pasted__pCube11_group_cell028_1" geometry={nodes.pasted__pCube11_group_cell028_1.geometry} material={materials.blinn10SG} />
        <mesh name="pasted__pCube11_group_cell028_2" geometry={nodes.pasted__pCube11_group_cell028_2.geometry} material={materials.blinn2SG} />
      </group>
    </group>
  )
}
